...
-- Which object types do you have? My schema contains FUNCTION, INDEX, PROCEDURE, SEQUENCE and TABLE
...
-- I can see OBJECT_NAME, OBJECT_TYPE, CREATED and LAST_DDL_TIME
...
Column "DBMS_METADATA.GET _DDL(TABLE, 'EMPLOYEES')" row
1
CREATE TABLE "A01644875 _SCHEMA_IK5GO" "EMPLOYEES"
"EMPLOYEE _ID" NUMBER,
"FIRST _NAME" VARCHAR2(50) NOT NULL ENABLE,
...
PCTINCREASE O FREELISTS 1 FREELIST GROUPS 1
BUFFER POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
TABLESPACE "USERS" ENABLE,
CONSTRAINT "FK _DEPARTMENT" FOREIGN KEY ("DEPARTMENT_ID")
REFERENCES "A01644875_SCHEMA_IK5GO" "DEPARTMENTS" ("DEPARTMENT_ID") ENABLE
) SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255
NOCOMPRESS LOGGING
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE O FREELISTS 1 FREELIST GROUPS 1
BUFFER_ POOL DEFAULT FLASH_CACHE DEFAULT CELL_ FLASH_CACHE DEFAULT)
TABLESPACE "USERS"
...
Column "DBMS_METADATA.GET_DDL(TABLE', TABLE_NAME)" row
1
CREATE TABLE "A01644875_SCHEMA_IK5GO". "DEPARTMENTS"
"DEPARTMENT_ID NUMBER
"DEPARTMENT_NAME" VARCHAR2(100) NOT NULL ENABLE, PRIMARY KEY ("DEPARTMENT ID")
USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE O FREELISTS 1 FREELIST GROUPS 1
BUFFER POOL DEFAULT FLASH_CACHE DEFAULT CELL_ FLASH _CACHE DEFAULT)
...
Column "DBMS_METADATA.GET_DDL(TABLE, TABLE_NAME)" row
2
CREATE TABLE "A01644875_SCHEMA_IKSGO" "EMPLOYEES"
( "EMPLOYEE_ ID" NUMBER,
"FIRST_NAME" VARCHAR2(50) NOT NULL ENABLE,
"LAST _NAME" VARCHAR2(50) NOT NULL ENABLE,
"SALARY" NUMBER(10,2),
"HIRE_DATE" DATE,
"DEPARTMENT_ID" NUMBER, PRIMARY KEY ("EMPLOYEE ID"
USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE O FREELISTS 1 FREELIST GROUPS 1
BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
TABLESPACE "USERS" ENABLE,
CONSTRAINT "FK_DEPARTMENT" FOREIGN KEY ("DEPARTMENT_ ID")
REFERENCES "A01644875 _SCHEMA_IK5GO". "DEPARTMENTS" ("DEPARTMENT_ID") ENABLE
) SEGMENT CREATION IMMEDIATE
PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255
NOCOMPRESS LOGGING
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
-- The DDL contains column definitions, data types, NOT NULL constraints, a primary key, and a foreign key constraint. It also includes Oracle storage parameters and tablespace information.
...
-- With EMIT_SCHEMA, the schema name appears in the DDL, without EMIT_SCHEMA, only the table name appears, making the DDL easier to migrate to another schema.
...
-- What changes would you need to make to your exported DDL? I would remove schema-qualified names and update foreign key references to match the new schema, and i would also ensure the objects are created in the correct order during migration.
...
-- When full Oracle access is available, there are more advanced tools for backup and migration such as Data Pump (expdp/impdp), SQLcl, Oracle SQL Developer export tools, transportable tablespaces, and Oracle Cloud migration services. 
-- These tools allow faster and more complete migration of both data and schema compared to DBMS_METADATA, which is mainly used for DDL extraction.